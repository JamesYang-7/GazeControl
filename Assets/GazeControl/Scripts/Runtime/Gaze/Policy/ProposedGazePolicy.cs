...
namespace GazeControl.Gaze.Policy
{
    ...
    ///
    /// Sampling a direction here instead was tried on 2026-08-25 and reverted the
    /// same day: the "the eyes are just centered" report that motivated it turned
    /// out to be a frame-rate bug in the animation layer, not this choice. See
    /// <see cref="HoldingReplayGazePolicy"/> for the measurement.
    ///
